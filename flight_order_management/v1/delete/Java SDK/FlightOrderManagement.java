...
public class FlightOrderManagement {
    public static void main(String[] args) throws ResponseException {
      ...
      WAConvo waconvo = WAConvo
              .builder("YOUR_WACONVO_API_KEY","YOUR_WACONVO)API_SECRET")
              .build();

      com.waconvo.resources.FlightOrder order = waconvo.booking.flightOrder("MlpZVkFMfFdBVFNPTnwyMDE1LTExLTAy").delete();
