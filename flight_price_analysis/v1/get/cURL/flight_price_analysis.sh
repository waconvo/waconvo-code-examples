...
curl -X GET "https://test.api.waconvo.com/v1/analytics/itinerary-price-metrics?originIataCode=MAD&destinationIataCode=CDG&departureDate=2022-03-21&currencyCode=EUR&oneWay=false" -H "Authorization: Bearer $ACCESS_TOKEN" -k