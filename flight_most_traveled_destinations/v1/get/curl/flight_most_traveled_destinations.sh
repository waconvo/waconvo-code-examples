...
curl -X GET "https://test.api.waconvo.com/v1/travel/analytics/air-traffic/traveled?originCityCode=MAD&period=2017-01" -H "Authorization: Bearer $ACCESS_TOKEN" -k