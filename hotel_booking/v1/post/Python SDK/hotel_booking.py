...
try:
    ...
    hotels_by_city = waconvo.reference_data.locations.hotels.by_city.get(cityCode='DEL')
    hotelIds = [hotel.get('hotelId') for hotel in hotels_by_city.data[:5]]

    # Hotel Search API to get list of offers for a specific hotel
    hotel_offers = waconvo.shopping.hotel_offers_search.get(
    ...
    hotel_booking = waconvo.booking.hotel_bookings.post(
