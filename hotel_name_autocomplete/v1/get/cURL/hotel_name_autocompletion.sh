...
curl -X GET "https://test.api.waconvo.com/v1/reference-data/locations/hotel?keyword=PARI&subType=HOTEL_LEISURE&subType=HOTEL_GDS" -H "Authorization: Bearer $ACCESS_TOKEN" -k
